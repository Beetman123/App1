 ...
 * A simple {@link Fragment} subclass.
    ...
    -   If the password has less then 6 characters in it a toast message is sent to the
        screen when the 'SIGN IN' button is pressed
 */
public class OldLoginFragment extends android.app.Activity {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // TODO - These two lines were commented out because they are causing errors and this code isn't being run
